<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderEdit.aspx.cs" Inherits="MySystemWeb.uAdmin.OrderEdit" %>
...
<body>
            ...
            <div class="fields">
                <div class="field">
                    ...
                    <div class="input">
                       ...
                       <%-- <asp:TextBox ID="TextOrder_num" runat="server"></asp:TextBox>--%><asp:Label ID="LabelOrder"
                ...
                <div class="field">
                    ...
                    <div class="input">
                           <select id="SelectBasicCourse" runat="server" onchange="getsubordinate_course()">
    ...
    <!-- end forms -->
    <script type="text/javascript">
            var basic_courseID = <%=basic_courseID%>;
            var detail_courseID=<%=detail_courseID %>;
            
         $.post("ajax/getbasic_course.aspx", function (data)
	        {

	            $("#SelectBasicCourse").html(data);
                $("#SelectBasicCourse").val(basic_courseID);
	        }, "html");
        
            $.post("ajax/getdetail_course.aspx", { basic_courseID: basic_courseID }, function (data)
            {
                 $("#SelectDetailCourse").html(data);
                 $("#SelectDetailCourse").val(detail_courseID);                
            }, "html");
