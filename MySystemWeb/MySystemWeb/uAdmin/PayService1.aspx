<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayService1.aspx.cs" Inherits="MySystemWeb.uAdmin.Payservice" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkfind()
        {
            ...
            var url = "PayService1.aspx?s=pf";           
            var service_name = document.getElementById("SelectService").value;
           
            if (service_name != "-1")
            {
                url += "&pay_stu_handler=" +encodeURI(service_name);
             }
                    ...
                    <tbody>
                        ...
                        <ItemTemplate>
                          <tr >   
                                ...
                                <td><%#Eval("pay_stu_time")%></td>                              
                                <td><%#Eval("pay_stu_handler")%></td>
