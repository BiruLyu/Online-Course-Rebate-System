<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetailCourseEdit.aspx.cs" Inherits="MySystemWeb.uAdmin.DetailCourseEdit" %>
	    ...
	    $(document).ready(function ()
	    {
	        $("#TextDetailCourse").blur(function checkusername()
	        {
	            ...
	            if (detailcourse != "")
	            {
	                ...
	                $.post("ajax/checkdetailcourse.aspx", { detailcourse: detailcourse }, function (data)
	                {
