...
namespace Utils
{
    ...
    {
        //默认密钥向量
        private static byte[] KeysAES = { 0x41, 0x72, 0x65, 0x79, 0x6F, 0x75, 0x6D, 0x79, 0x53, 0x6E, 0x6F, 0x77, 0x6D, 0x61, 0x6E, 0x3F };
        private static byte[] KeysDES = { 0x12, 0x34, 0x56, 0x78, 0x90, 0xAB, 0xCD, 0xEF };
        public static string EncodeAES(string encryptString, string encryptKey)
        {
        ...
        public static string DecodeAES(string decryptString, string decryptKey)
        {
            try
            {
        ...
        public static string UrlEncode(string str, string key)
        {
        ...
        public static string UrlDecode(string str, string key)
        {
            try
            {
                DESCryptoServiceProvider provider = new DESCryptoServiceProvider();
